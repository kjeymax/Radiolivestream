...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player Bot** \nI Can Play Radio/Stream Music In Channels & Groups 24x7 Nonstop. Made with ❤️ By @kavinduaj!"
HELP = """🏷️ **Need Help?** 🤔
__(Join @lkhitech For Support)__
...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton('CHANNEL', url='https://t.me/lkhitech'),
        InlineKeyboardButton('SUPPORT', url='https://t.me/hitechlkgroup'),
    ],
    [
